...
function DialogClose({
  ...
  return <DialogPrimitive.Close data-slot="dialog-close" className="text-white" {...props} />
}
...
function DialogWrapper({ children, trigger, header, open, onOpenChange }: DialogWrapperProps) {
  return (
